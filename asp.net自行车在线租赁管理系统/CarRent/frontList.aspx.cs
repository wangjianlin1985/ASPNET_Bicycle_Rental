...
using System.Data;
public partial class CarRent_frontList : System.Web.UI.Page
{
    ...
    private void BindcarObj()
    {
        ...
        for (int i = 0; i < carObjDs.Tables[0].Rows.Count; i++)
        {
            ...
            li = new ListItem(dr["carName"].ToString(),dr["chepaiNo"].ToString());
            carObj.Items.Add(li);
        }
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?carObj=" + carObj.SelectedValue.Trim() + "&&userObj=" + userObj.SelectedValue.Trim()+ "&&rentTime=" + rentTime.Text.Trim()+ "&&returnTime=" + returnTime.Text.Trim());
        }
